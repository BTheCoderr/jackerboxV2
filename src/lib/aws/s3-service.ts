...
import { getAwsRegion, getAwsAccessKeyId, getAwsSecretAccessKey, getAwsS3BucketName } from './env';
...
const bucketName = getAwsS3BucketName();
...
export function getPublicS3Url(key: string): string {
  ...
  return `https://${bucketName}.s3.${getAwsRegion()}.amazonaws.com/${key}`;
}
